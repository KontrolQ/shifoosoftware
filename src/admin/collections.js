  ...
  software: {
    ...
    columns: [
      ...
      col("added", "Added", "created_at", "date",
        { cell: (held) => ({ text: describedDate(held.created_at), muted: true }) }),
    ],
...
COLLECTIONS.hotlinks = {
  ...
  columns: [
    ...
    col("added", "Added", "added_at", "date",
      { cell: (held) => ({ text: describedDate(held.added_at), muted: true }) }),
  ],
...
COLLECTIONS.requests = {
  ...
  columns: [
    ...
    col("asked", "Asked", "happened_at", "date", { on: true,
      cell: (held) => ({ text: describedDate(held.happened_at), muted: true }) }),
